    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"cp", header:["Unit C.P."],format:webix.i18n.priceFormat,fillspace:2},
                {id:"quantity", header:" Qty",footer:{content:"summColumn"},sort:"int"},
                {id:"amount", header:["Amount"],format:webix.i18n.priceFormat,math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/purchase/apiv1/delete/creditpurchasereturn";
