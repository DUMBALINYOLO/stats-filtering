    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"sp",editor:"text",format:webix.i18n.priceFormat, header:["Unit S.P",{content:"numberFilter"}],fillspace:2},
                {id:"cp",editor:"text",format:webix.i18n.priceFormat, header:["Unit C.P",{content:"numberFilter"}],fillspace:2},
                {id:"amount",format:webix.i18n.priceFormat, header:["Sales Amount",{content:"numberFilter"}],math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost",format:webix.i18n.priceFormat, header:["Cost of Sales",{content:"numberFilter"}],math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"profit", header:["Profit",{content:"numberFilter"}],math:"[$r,amount]-[$r,cost]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/sales/apiv1/delete/creditsalesreturn";
