    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount", header:["Sales Amount",{content:"numberFilter"}],math:"[$r,sp]*[$r,quantity]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost", header:["Cost of Sales",{content:"numberFilter"}],math:"[$r,cp]*[$r,quantity]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"profit", header:["Profit",{content:"numberFilter"}],math:"[$r,amount]-[$r,cost]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/sales/apiv1/delete/cashsale";
