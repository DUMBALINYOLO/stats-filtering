    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount", header:["Amount"],math:"[$r,cp]*[$r,quantity]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/purchase/apiv1/delete/cashpurchase";
