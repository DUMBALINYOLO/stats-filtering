    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"sp",editor:"text", header:["Unit S.P",{content:"numberFilter"}],format:webix.i18n.priceFormat,fillspace:2},
                {id:"cp",editor:"text", header:["Unit C.P",{content:"numberFilter"}],format:webix.i18n.priceFormat,fillspace:2},
                {id:"amount", header:["Sales Amount",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost", header:["Cost of Sales",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"profit", header:["Profit",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,amount]-[$r,cost]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/sales/apiv1/delete/creditsale";
