    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"cp", header:["Unit C.P",{content:"numberFilter"}],format:webix.i18n.numberFormat,sort:"int",fillspace:1},
                {id:"sp", header:["Unit S.P",{content:"numberFilter"}],format:webix.i18n.numberFormat,sort:"int",fillspace:1},
				{id:"quantity", header:" Qty",sort:"int",fillspace:1},
				{id:"tcp",math:"[$r,cp]*[$r,quantity]", header:["Total C.P",{content:"numberFilter"}],format:webix.i18n.numberFormat,footer:{content:"summColumn"},sort:"int",fillspace:2},
				{id:"tsp",math:"[$r,sp]*[$r,quantity]", header:["Total S.P",{content:"numberFilter"}],format:webix.i18n.numberFormat,footer:{content:"summColumn"},sort:"int",fillspace:2},
				{id:"mgp", math:"[$r, tsp]-[$r, tcp]",header:["Expected Profit",{content:"numberFilter"}],format:webix.i18n.numberFormat,footer:{content:"summColumn"},sort:"int",fillspace:2},
