    ...
    cols: [
        {
            ...
            columns: [
                ...
                { id: "sp",format:webix.i18n.numberFormat, editor: "text", header: ["Unit S.P", { content: "numberFilter" }], fillspace: 2 },
                { id: "amount",format:webix.i18n.numberFormat, header: ["Sales Amount", { content: "numberFilter" }], math: "[$r,sp]*[$r,quantity]", footer: { content: "summColumn" }, sort: "int", fillspace: 3 },
