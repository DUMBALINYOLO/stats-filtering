    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount",format:webix.i18n.numberFormat, header:["Amount"],math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:true},
            ...
            on:{
                ...
                onBeforeEditStop:function(state,editor,updated){
                    ...
                    old_quantity = $$("sales_datatable").getItem(editor.row).old_quantity;
