    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"cp",format:webix.i18n.numberFormat, header:"Unit CP",fillspace:true, editor:"text"},
                {id:"sp",format:webix.i18n.numberFormat, header:"Unit SP",fillspace:true, editor:"text"},
                {id:"amount",format:webix.i18n.numberFormat, header:["Amount"],math:"[$r,cp]*[$r,order_qty]",footer:{content:"summColumn"},sort:"int",fillspace:true},
