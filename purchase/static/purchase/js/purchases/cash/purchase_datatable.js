    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"cp", header:"Unit CP",format:webix.i18n.numberFormat,fillspace:true, editor:"text"},
                {id:"sp", header:"Unit SP",format:webix.i18n.numberFormat,fillspace:true, editor:"text"},
                {id:"amount", header:["Amount"],format:webix.i18n.numberFormat,math:"[$r,cp]*[$r,order_qty]",footer:{content:"summColumn"},sort:"int",fillspace:true},
